...
#define ANN_DIFF(x,y)		((y) - (x))
	  ...
	  DLL_API void initKdTree(double *data, int n, int dim, int bs = 1, ANNsplitRule split = ANN_KD_SUGGEST);

	  DLL_API void annKdSearch(ANNpoint q, int k, ANNidxArray nnIdx, ANNdistArray dd, double eps = 0.0);

	  DLL_API void annkPriSearch(ANNpoint q, int k, ANNidxArray nnIdx, ANNdistArray dd, double eps = 0.0);
